...
public enum CustomDSVOrientation {

    HORIZONTAL {
        @Override
        CustomHelper createHelper() {
    ...
    //Package private
    abstract CustomHelper createHelper();
    ...
    interface CustomHelper {
        ...
        void shiftViewCenter(CustomDirection direction, int shiftAmount, Point outCenter);
        ...
        boolean hasNewBecomeVisible(CustomDiscreteScrollLayoutManager lm);
    ...
    protected static class HorizontalHelper implements CustomHelper {
        ...
        @Override
        public void shiftViewCenter(CustomDirection direction, int shiftAmount, Point outCenter) {
        ...
        @Override
        public boolean hasNewBecomeVisible(CustomDiscreteScrollLayoutManager lm) {
    ...
    protected static class VerticalHelper implements CustomHelper{
